...
describe('Clock', function()
  ...
  it('should clock in and clock out an entry', function()
    ...
    assert.are.same('(Org) [0:00] (Test orgmode)', require('orgmode').action('clock.get_statusline'):wait())
    ...
    assert.are.same('  :END:', vim.fn.getline(7))
    assert.are.same('', require('orgmode').action('clock.get_statusline'):wait())
  ...
  it('should clock out first entry from same file once second entry is clocked in', function()
    ...
    assert.are.same('(Org) [0:00/2:00] (First clocked in)', require('orgmode').action('clock.get_statusline'):wait())
    ...
    vim.cmd([[silent! write!]])
    assert.are.same('(Org) [0:00] (Second clocked in)', require('orgmode').action('clock.get_statusline'):wait())
  end)
  ...
  it('should clock out entry from another file once entry is clocked in', function()
    ...
    assert.are.same('(Org) [0:00] (Third file headline)', require('orgmode').action('clock.get_statusline'):wait())
  end)
