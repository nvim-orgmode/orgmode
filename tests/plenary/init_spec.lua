...
describe('Init', function()
  it('should load and parse files from folder', function()
    ...
    assert.are.same(1, #org.files.get(todo_archive_file).sections)
