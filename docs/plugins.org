...
:CUSTOM_ID: orgnomics
:END:
Link: [[https://ar-at-localhost.github.io/yalms/][Yalms]]

Part of [[https://ar-at-localhost.github.io/yalms/][Yalms]] — adds Snacks-powered pickers, an improved capture window built with Snacks, and a clock management system for orgmode.
