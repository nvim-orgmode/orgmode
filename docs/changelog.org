#+OPTIONS: H:9 ^:nil
* Changelog
** [[https://github.com/nvim-orgmode/orgmode/compare/0.7.4...0.7.5][0.7.5]] (2026-06-18)
*** Features
- *luarocks*: Fix missing dependencies for luarocks (#1161) ([[https://github.com/nvim-orgmode/orgmode/commit/f93d9d2][f93d9d2]])

** [[https://github.com/nvim-orgmode/orgmode/compare/0.7.3...0.7.4][0.7.4]] (2026-06-18)
*** Features
- *luarocks*: Return dependency on tree-sitter-orgmode ([[https://github.com/nvim-orgmode/orgmode/commit/2fa42fe][2fa42fe]])
- *treesitter*: Use vim.system for installation and print errors ([[https://github.com/nvim-orgmode/orgmode/commit/b1952f7][b1952f7]])
- *promises*: Switch to coroutine based Promise (#1131) ([[https://github.com/nvim-orgmode/orgmode/commit/b6be301][b6be301]])
- *treesitter*: nvim-treesitter-context support (#1123) ([[https://github.com/nvim-orgmode/orgmode/commit/98b3a2b][98b3a2b]])
- *highlights*: Use tree-sitter to hide leading stars ([[https://github.com/nvim-orgmode/orgmode/commit/5ea6251][5ea6251]])
- *footnotes*: Use footnotes from tree-sitter grammar (#1140) ([[https://github.com/nvim-orgmode/orgmode/commit/58b33f4][58b33f4]])

*** Bug fixes
- *files*: Handle empty line on Neovim 0.12.3 in set_text ([[https://github.com/nvim-orgmode/orgmode/commit/c8e3d6c][c8e3d6c]])
- *highlighter*: Schedule callback for todos (#1156) ([[https://github.com/nvim-orgmode/orgmode/commit/5f7fbf7][5f7fbf7]])
- *agenda*: goto item with multiple tabpages (#1149) ([[https://github.com/nvim-orgmode/orgmode/commit/4f02f19][4f02f19]])
- OrgConfigOpts mandatory arguments (#1151) ([[https://github.com/nvim-orgmode/orgmode/commit/cef81ff][cef81ff]])
- correct Windows localized date encoding (#1142) ([[https://github.com/nvim-orgmode/orgmode/commit/19209e6][19209e6]])
- *capture*: ignore ui2 windows when checking for window count ([[https://github.com/nvim-orgmode/orgmode/commit/6909d18][6909d18]])

** [[https://github.com/nvim-orgmode/orgmode/compare/0.7.2...0.7.3][0.7.3]] (2026-05-05)
*** Features
- *agenda*: highlight upcoming deadlines as `@org.agenda.deadline.upcoming` (#1138) ([[https://github.com/nvim-orgmode/orgmode/commit/260a366][260a366]])
- *capture*: have `headline` in templates take a string or a function that returns a string. (#1133) ([[https://github.com/nvim-orgmode/orgmode/commit/0f821b2][0f821b2]])
- *agenda*: add `@org.agenda.weekend.today` highlight (#1135) ([[https://github.com/nvim-orgmode/orgmode/commit/2ed4742][2ed4742]])
- ClockedIn and ClockedOut events (#1111) ([[https://github.com/nvim-orgmode/orgmode/commit/9deee54][9deee54]])
- *add_note*: include heading title on add_note editor (#1100) ([[https://github.com/nvim-orgmode/orgmode/commit/95cb541][95cb541]])
- NoteAdded event (#1112) ([[https://github.com/nvim-orgmode/orgmode/commit/72c6d0c][72c6d0c]])
- *lsp*: Show basic loading progress ([[https://github.com/nvim-orgmode/orgmode/commit/0e8cba3][0e8cba3]])
- *lsp*: Add references support ([[https://github.com/nvim-orgmode/orgmode/commit/4610182][4610182]])
- Add support for basic LSP (#1088) ([[https://github.com/nvim-orgmode/orgmode/commit/95fd9b3][95fd9b3]])

*** Bug fixes
- *links*: creating link from visual mode (#1139) ([[https://github.com/nvim-orgmode/orgmode/commit/1a9d7bc][1a9d7bc]])
- *treesitter*: Ignore empty line from nodes ending on col 0 ([[https://github.com/nvim-orgmode/orgmode/commit/6446ad3][6446ad3]])
- *agenda*: Increase height of tmp window to avoid winbar issues ([[https://github.com/nvim-orgmode/orgmode/commit/b3b58f7][b3b58f7]])
- *buffers*: Fix fallback for finding a buffer by filename (#1126) ([[https://github.com/nvim-orgmode/orgmode/commit/a214db3][a214db3]])
- *agenda*: Do not attempt to set text for view that is empty ([[https://github.com/nvim-orgmode/orgmode/commit/1ab7b45][1ab7b45]])
- *folds*: update fold boundaries after headline edits (#1078) ([[https://github.com/nvim-orgmode/orgmode/commit/2fc30d3][2fc30d3]])
- *set_tags*: better tag parsing for hyphens and whitespaces (#1098) ([[https://github.com/nvim-orgmode/orgmode/commit/2b2f327][2b2f327]])
- *mappings*: Do not replace keycodes for <CR> fallback if not required ([[https://github.com/nvim-orgmode/orgmode/commit/5e90dc5][5e90dc5]])
- *todo_keywords*: Do not set todo keyword on repeater if there was not any before ([[https://github.com/nvim-orgmode/orgmode/commit/b681e55][b681e55]])
- *buffers*: Get full path to buffer name by bufnr ([[https://github.com/nvim-orgmode/orgmode/commit/eff6b77][eff6b77]])
- *buffers*: normalize buffer name ([[https://github.com/nvim-orgmode/orgmode/commit/89b684e][89b684e]])
- *agenda*: correctly re-render agenda on repeated todo state changed ([[https://github.com/nvim-orgmode/orgmode/commit/c480161][c480161]])

** [[https://github.com/nvim-orgmode/orgmode/compare/0.7.1...0.7.2][0.7.2]] (2025-12-03)
*** Breaking changes
- *agenda*: Add time grid (#1038) ([[https://github.com/nvim-orgmode/orgmode/commit/d59c7b2][d59c7b2]])

*** Features
- *latex*: Add support for inline math (#1059) ([[https://github.com/nvim-orgmode/orgmode/commit/e4e48b5][e4e48b5]])
- *treesitter*: Compile parser using tree-sitter if available (#1062) ([[https://github.com/nvim-orgmode/orgmode/commit/c1005a0][c1005a0]])
- *files*: Use TS string parser for non-nightly versions (#1060) ([[https://github.com/nvim-orgmode/orgmode/commit/b525c77][b525c77]])
- *agenda*: Add `org-agenda-show-future-repeats` ([[https://github.com/nvim-orgmode/orgmode/commit/1f41121][1f41121]])
- *agenda*: use todo hl group for range grid ([[https://github.com/nvim-orgmode/orgmode/commit/b7bcb90][b7bcb90]])
- *agenda*: Add option to hide custom agenda views that are empty ([[https://github.com/nvim-orgmode/orgmode/commit/090965e][090965e]])
- *agenda*: Show grid without times for remove-range-match ([[https://github.com/nvim-orgmode/orgmode/commit/9bfba3d][9bfba3d]])
- allow to define multiple todo keyword sequences (#974) ([[https://github.com/nvim-orgmode/orgmode/commit/1531650][1531650]])
- *agenda*: Add remove-range-match option for time grid ([[https://github.com/nvim-orgmode/orgmode/commit/a3ce79c][a3ce79c]])
- *agenda*: Highlight links and dates using extmarks ([[https://github.com/nvim-orgmode/orgmode/commit/f4dde88][f4dde88]])
- *agenda*: Allow opening links from agenda headlines ([[https://github.com/nvim-orgmode/orgmode/commit/de701e8][de701e8]])

*** Bug fixes
- *notifications*: ignore repeater dates that are same as original date ([[https://github.com/nvim-orgmode/orgmode/commit/03863e9][03863e9]])
- *files*: Disable swapfile for buffers loaded in background ([[https://github.com/nvim-orgmode/orgmode/commit/638b2b4][638b2b4]])
- *highlighter*: return early if buffer is detached during async parse ([[https://github.com/nvim-orgmode/orgmode/commit/f37b31b][f37b31b]])
- *agenda*: Do not exclude grid end time in agenda ([[https://github.com/nvim-orgmode/orgmode/commit/0bde64c][0bde64c]])
- *files*: Disable modeline when loading buffers ([[https://github.com/nvim-orgmode/orgmode/commit/5f6eb90][5f6eb90]])
- *agenda*: Reload agenda when headline range is updated ([[https://github.com/nvim-orgmode/orgmode/commit/46cd1df][46cd1df]])
- *files*: Add default value for file lines ([[https://github.com/nvim-orgmode/orgmode/commit/266888a][266888a]])
- *files*: remove string tree-sitter parser (#1041) ([[https://github.com/nvim-orgmode/orgmode/commit/63ace3c][63ace3c]])
- *windows*: handle Windows file paths correctly in refile (#1042) ([[https://github.com/nvim-orgmode/orgmode/commit/03777ca][03777ca]])
- *stars*: Ignore stars node that end on column 0 ([[https://github.com/nvim-orgmode/orgmode/commit/4775d1a][4775d1a]])
- *formatting*: Prevent infinite loop on formatting closed folds ([[https://github.com/nvim-orgmode/orgmode/commit/b6907d5][b6907d5]])
- *datetree*: Use current date and time as default value for datetree ([[https://github.com/nvim-orgmode/orgmode/commit/ad5d652][ad5d652]])
- *autocompletion*: Fix insert link autocompletion ([[https://github.com/nvim-orgmode/orgmode/commit/a49d5d4][a49d5d4]])
